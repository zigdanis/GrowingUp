# PR 13 Plan: Image Source Menu and Photo Preview Flow

This PR is planning only. It should not change app behavior yet.
...
- Do not make app-code changes in this planning PR.

## Open Decisions

- Should the source menu be anchored near the tapped image button or near the bottom in the ChatGPT style?
- What fixed height should the lightweight photo preview modal use on different phone sizes?
- Which native photo picker API best matches the desired All Photos behavior?
- Should the actions menu stay mounted behind Camera/Photos previews or be recreated when the user backs out?
